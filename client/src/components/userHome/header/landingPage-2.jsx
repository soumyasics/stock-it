...
import '../../../components/userHome/header/landingPage-2.css'
    ...
    <div className='landingheader'>
      ...
      <div className='landingheader-h1'>
        <div className='landingheader-left'>
          ...
          <br />
          <p>Your Gateway to Informed Investing and Empowered Trading. Explore real-time stock prices, <br />
            dynamic trading active, and comprehensive portfolio management tools.</p>
          <br />
          <p>
            Join us in revolutionizing the stock trading experience - <br />
            where informed decision meet seamless transaction</p>
      ...
      <div className='landingheader-h2-middle'>
        ...
        <div className='middle-step'>
          <div className='middle-step-1'>
            ...
            <p>Step 1 <br /> Register yourserlf</p>
          </div>
          <div className='middle-step-2'>
            <img src={imgStep2} alt="" />
            <p>Step 2 <br />search for your <br /> Favourite listed companies</p>
          </div>
          <div className='middle-step-3'>
            <img src={imgStep3} alt="" />
            <p>Step 3 <br /> Browse through <br /> easy-to-understand and visually <br />appealing data</p>
          </div>
        </div>
