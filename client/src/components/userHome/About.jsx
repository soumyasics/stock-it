...
function About() {
    return (
        <div className='about-background'>
            <h5 className=' about-heading'>Invest in everything<br />
                Online platform to invest in stocks, derivatives, mutual funds, and more
            </h5>
            <img className="img-fluid about-image" src={img7} alt="" />
            <h6 className='about-second-heading'>“Our mission is to help every Indian confidently Up their wealth”</h6>
            <p className='about-pargaraph'>To empower investors of all levels with real-time, insightful, and personalized<br />
                financial information, enabling informed decision-making and fostering <br />
                a community of knowledgeable and confident market participants.</p>

            <p className='about-pargaraph' >To democratize access to the stock market by providing an intuitive, data-driven platform
                that offers real-time information, advanced analytics, and <br />
                personalized insights, empowering users to make informed investment decisions and achieve financial growth.</p>
            <div class="row about-middle-box">
                <div class="col">
                    <img src={img8} alt="" />
                    <p className='about-middle-box-heading'>Accessible</p>
                    <p className='about-middle-box-description'>Powerful Desktop Platform <br />
                        to all users</p>
                </div>
                <div class="col box1">
                    <img src={img9} alt="" />
                    <p className='about-middle-box-heading'>Affordable</p>
                    <p className='about-middle-box-description'>Cost-Effective Solutions,<br />Strategic Market Engagement </p>
            ...
            <p className='about-pargaraph2'> To empower investors of all levels with real-time, insightful, and personalized
                financial information, enabling informed decision-making and fostering <br />
                a community of knowledgeable and confident market participants.</p>
                ...
                <div class="col">
                    <div className='about-last-inner-box'>
                        ...
                        <p className='about-last-inner-box-text'>
                            ...
                            and opportunity is equally available to all.</p>
